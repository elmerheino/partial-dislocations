...
def normalizedDepinnings(depinning_path : Path, plot_save_folder : Path, data_save_path : Path, json_save_path : Path, optimized=False, seed_count = 10, h5path="debug-dict/partial-dislocation/partial-dislocation.h5"):
    """
