...
kansion_nimi = "5-8-weak-coupling"

for sys_size in [32, 64, 128, 256, 512, 1024]:
    # save_path = f"${{WRKDIR}}/{kansion_nimi}/perfect/l-{sys_size}"
    # spawn_relaxation(-4, -3, 20, system_size=sys_size, d0=0, seeds=10, save_path=save_path, 
    ...
    for d0 in powers_of_two:
        ...
        spawn_relaxation(-4, -3, 20, system_size=sys_size, d0=d0, seeds=10, save_path=save_path, 
